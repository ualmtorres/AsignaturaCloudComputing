...
////
# Planificación recomendada para seguir el Programa Especializado: Cloud Engineer Learning Path - Máster en Tecnologías y Aplicaciones en Ingeniería Informática
...
Planificación recomendada para seguir el programa especializado _Cloud Engineer Learning Path_ durante el desarrollo de la asignatura de Cloud Computing.
...
* Automatización de infraestructura en Google Cloud con Terraform
