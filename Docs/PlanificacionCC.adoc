...
** Contenidos
*** link:Tema1/01ModelosDeServicioConComputacionEnLaNube.pdf[Presentación: Modelos de servicio con Computación en la Nube, windows=blank]
...
*** link:Tema2/CreacionBDMySQLGoogleCloud.html[Tutorial: Creación de instancia MySQL en Google Cloud, windows=blank]
*** link:Tema2/AplicacionSGEnModoIaaS.html[Tutorial: Despliegue de una aplicación con base de datos en modo IaaS, windows=blank]
*** link:Tema2/Enlaces.html[Enlaces de interés, windows=blank]
...
** Metodología
*** Clases teórico-prácticas con presentaciones y tutoriales de casos prácticos
*** Aprendizaje autónomo o autodirigido donde los estudiantes asumen el control de su proceso de aprendizaje y trabajan de forma independiente para adquirir conocimientos y habilidades.
...
*** Estudio de casos prácticos de despliegue en modo IaaS donde los estudiantes trabajan con casos reales o ficticios para fomentar la toma de decisiones, el debate y la argumentación.
*** Aprendizaje basado en competencias enfocado en el desarrollo de habilidades y destrezas prácticas, más que en la mera adquisición de contenidos teóricos.
...
*** link:Tema2/DespliegueAppEngineVercel.html[Tutorial: Despliegue en Vercel y Google App Engine, windows=blank]
*** link:Tema3/Enlaces.html[Enlaces de interés, windows=blank]
...
*** Aprendizaje autónomo o autodirigido donde los estudiantes asumen el control de su proceso de aprendizaje y trabajan de forma independiente para adquirir conocimientos y habilidades.
*** Tutoriales en modalidad de _flipped classroom_, donde los alumnos realizan la actividad de forma autónoma y se resuelven dudas en la clase presencial.
*** Estudio de casos prácticos de despliegue en modo PaaS donde los estudiantes trabajan con casos reales o ficticios para fomentar la toma de decisiones, el debate y la argumentación.
*** Aprendizaje basado en competencias enfocado en el desarrollo de habilidades y destrezas prácticas, más que en la mera adquisición de contenidos teóricos.
...
*** link:Tema4/Enlaces.html[Enlaces de interés, windows=blank]
...
*** Aprendizaje autónomo o autodirigido donde los estudiantes asumen el control de su proceso de aprendizaje y trabajan de forma independiente para adquirir conocimientos y habilidades.
*** Tutoriales en modalidad de _flipped classroom_, donde los alumnos realizan la actividad de forma autónoma y se resuelven dudas en la clase presencial.
*** Estudio de casos prácticos de despliegue con contenedores donde los estudiantes trabajan con casos reales o ficticios para fomentar la toma de decisiones, el debate y la argumentación.
*** Aprendizaje basado en competencias enfocado en el desarrollo de habilidades y destrezas prácticas, más que en la mera adquisición de contenidos teóricos.
...
*** link:Tema5/Enlaces.html[Enlaces de interés, windows=blank]
...
*** link:Tema6/Enlaces.html[Enlaces de interés, windows=blank]
...
*** Aprendizaje autónomo o autodirigido donde los estudiantes asumen el control de su proceso de aprendizaje y trabajan de forma independiente para adquirir conocimientos y habilidades.
*** Tutoriales en modalidad de _flipped classroom_, donde los alumnos realizan la actividad de forma autónoma y se resuelven dudas en la clase presencial.
*** Estudio de casos prácticos de despliegue en Kubernetes donde los estudiantes trabajan con casos reales o ficticios para fomentar la toma de decisiones, el debate y la argumentación.
*** Aprendizaje basado en competencias enfocado en el desarrollo de habilidades y destrezas prácticas, más que en la mera adquisición de contenidos teóricos.
*** Actividades de laboratorio para realizar de forma autónoma en forma de proyecto.
...
Las metodologías de aprendizaje utilizadas en estos cursos son variadas e incluyen:

*** _Aprender haciendo_, con una gran cantidad de laboratorios prácticos que permiten adquirir experiencia real en el uso de los servicios cloud.  
*** _Gamificación_, donde los estudiantes obtienen puntos y logros a medida que completan los cursos y laboratorios, lo que fomenta la motivación y el compromiso con el aprendizaje.
*** _Microlearning_, con contenidos breves y concisos que facilitan la asimilación de conceptos clave en poco tiempo.
*** _Aprendizaje basado en el pensamiento crítico_, fomentando la reflexión y el análisis de casos prácticos para desarrollar habilidades de resolución de problemas en entornos cloud.

Los cursos que componen el programa son los siguientes:
