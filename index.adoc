...
* Clases: Aulas 14 y 19 - CITE III
* Sesiones presenciales (link:Docs/PlanificacionCC.html[Planificación de la asignatura])
** 6 y 13 de octubre de 16h a 18h. Aula 14 CITE III
** 20 y 27 de octubre. 3, 10, 17 y 24 de noviembre de 16h a 18h. Aula 19 CITE IIII
...
** https://aulavirtual.ual.es/webapps/blackboard/execute/launcher?type=Course&id=_3404_1&url=[Aula Virtual]
...
Si eres alumno de la asignatura en la UAL completa esta https://forms.gle/9EbYYYfBLhBJbHnP7[pequeña encuesta] que permita valorar tus conocimientos iniciales y adaptar el desarrollo de la asignatura.
