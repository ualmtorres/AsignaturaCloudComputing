...
* link:https://docs.google.com/presentation/d/14_bGZqZGjY7SgPIy2HTgC_SJbeiQJfwQIqwGl4A8O34/edit?usp=sharing[Presentación: Modelos de servicio con Computación en la Nube, windows=blank]
